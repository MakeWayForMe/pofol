...
(function($) {
    ...
    $(function() {
        ...
        $.ajax({
            type: 'GET',
            // url: '/portfolio/yuhan/data/yuhancare/inc/json/menu_'+lang+'.json',
            url: '/portfolio/yuhan/data/yuhancare/inc/json/menu_test.json',
            async: false,
            dataType: 'json',
        ...
        if(userDeviceType == 'pc') {
            //리뉴얼 전 레거시
            var bodyColor = $('#container').attr('data-body');
            if(bodyColor === 'white') $('body').addClass('white');
            //리뉴얼 전 레거시
        ...
        $('.link_open').on('click', function() {
            if($(this).attr('title') === '열기') {
                $('.link_open').attr('title','열기').removeClass('on');
                $('.link_open + ul').removeClass('active');
                $(this).attr('title','닫기').addClass('on').siblings('ul').addClass('active');
            } else {
                $(this).attr('title','열기').removeClass('on').siblings('ul').removeClass('active');
            }
        });
